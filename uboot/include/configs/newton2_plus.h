...
/*    #define CONFIG_BOOTCOMMAND "tftpboot 0x80600000 bliu/85/uImage.new; bootm" */
	#define CONFIG_BOOTCOMMAND "mmc read 0x80600000 0x1800 0x6000; bootm 0x80600000"
  #else
...
#define CONFIG_JZ_MMC_MSC0_PA_ENABLE_PULL
#endif
...
#define CONFIG_SM5007_I2C_SCL	GPIO_PD(31)
#define CONFIG_SM5007_I2C_SDA	GPIO_PD(30)
 ...
 * Keys.
 */
#define CONFIG_GPIO_USB_DETECT		GPIO_PD(7)
