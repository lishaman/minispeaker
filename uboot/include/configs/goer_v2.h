...
#ifndef __CONFIG_GOER_V2_H__
#define __CONFIG_GOER_V2_H__
...
#define CONFIG_SYS_APLL_FREQ		948000000
#define CONFIG_SYS_MPLL_FREQ		492000000
...
#define BOOTARGS_COMMON "console=ttyS3,57600n8 mem=128M@0x0"
	...
	#define CONFIG_BOOTCOMMAND "spinor read 0x30000 0x800000 0x80800000;bootm 0x80800000"
	#else
...
#define CONFIG_BOOTCOMMAND    "bootx spi 0x81f00000 0xd00000"
#endif
