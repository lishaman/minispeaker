...
static void cw_bat_work(struct work_struct *work)
{
	...
	dev_dbg(&cw_bat->client->dev, "cw_bat->charger_mode = %d, cw_bat->time_to_empty = %d, cw_bat->capacity = %d, cw_bat->voltage = %d, cw_bat->dc_online = %d, cw_bat->usb_online = %d\n",\
