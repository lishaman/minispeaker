#ifndef __LINUX_ZET6621_tsc_TS_H__
#define __LINUX_ZET6621_tsc_TS_H__

#define COORD_INTERPRET(MSB_BYTE, LSB_BYTE) \
	((u16)(MSB_BYTE) << 8 | (u16)(LSB_BYTE))
...
#define ZET6621_tsc_NAME	"zet6221_tsc"
...
#define POINT_READ_BUF	(3 + 4 * CFG_MAX_TOUCH_POINTS)
