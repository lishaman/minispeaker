...
void dma_config_early_sleep(struct sleep_buffer *sleep_buffer)
{
	...
	count = sleep_buffer->total_len/sleep_buffer->nr_buffers/config.burst_len;
	...
	/*
	 * now sleep_desc stores the desc ,
	 * we make a new pdma_config, other configs remains
