...
int control_InterruptAudioPacketsClear(u16 baseAddr, u8 value)
{
	LOG_TRACE1(value);
	halInterrupt_AudioPacketsClear(baseAddr + IH_BASE_ADDR, value);
	return TRUE;
}

u8 control_InterruptAudioPacketsState(u16 baseAddr)
{
	LOG_TRACE();
	return halInterrupt_AudioPacketsState(baseAddr + IH_BASE_ADDR);
}

int control_InterruptOtherPacketsClear(u16 baseAddr, u8 value)
{
	LOG_TRACE1(value);
	halInterrupt_OtherPacketsClear(baseAddr + IH_BASE_ADDR, value);
	return TRUE;
}

u8 control_InterruptOtherPacketsState(u16 baseAddr)
{
	LOG_TRACE();
	return halInterrupt_OtherPacketsState(baseAddr + IH_BASE_ADDR);
}

int control_InterruptPacketsOverflowClear(u16 baseAddr, u8 value)
{
	LOG_TRACE1(value);
	halInterrupt_PacketsOverflowClear(baseAddr + IH_BASE_ADDR, value);
	return TRUE;
}

u8 control_InterruptPacketsOverflowState(u16 baseAddr)
{
	LOG_TRACE();
	return halInterrupt_PacketsOverflowState(baseAddr + IH_BASE_ADDR);
}
/////
int control_InterruptAudioSamplerClear(u16 baseAddr, u8 value)
{
	LOG_TRACE1(value);
	halInterrupt_AudioSamplerClear(baseAddr + IH_BASE_ADDR, value);
	return TRUE;
}

u8 control_InterruptAudioSamplerState(u16 baseAddr)
{
	LOG_TRACE();
	return halInterrupt_AudioSamplerState(baseAddr + IH_BASE_ADDR);
}
