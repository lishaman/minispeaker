...
struct epd_panel_info epd_panel_info_init(void)
{
	...
	struct epd_panel_info xd1_info;
	...
	xd1_info.epd_var.activate	= FB_ACTIVATE_NOW;
	xd1_info.epd_var.accel_flags	= FB_ACCELF_TEXT;
	...
	xd1_info.epd_var.vmode		= FB_VMODE_NONINTERLACED;
