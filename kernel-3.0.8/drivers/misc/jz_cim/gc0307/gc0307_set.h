#ifndef __GC0307_SET_H__
#define __GC0307_SET_H__

int gc0307_preview_set(struct cim_sensor *sensor_info);
int gc0307_capture_set(struct cim_sensor *sensor_info);
int gc0307_size_switch(struct cim_sensor *sensor_info,int width,int height);
...
static const struct gc0307_reg gc0307_init_table[]= {
        //close output
        {0x43,0x00},
        {0x44,0xa2},
#if 1
