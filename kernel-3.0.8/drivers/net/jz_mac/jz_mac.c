...
#define CIMCDR_CIM_STOP		(1 << 28)
#define CIMCDR_CIM_BUSY		(1 << 29)
#define CIMCDR_CE_CIM		(1 << 30)
#define CIMCDR_CIMPCS_MPLL	(1 << 31)

#define MPHYC_TXCLK_SEL		(1 << 31)
...
#if 0	/* this can be cacelled for we should support it---bliu*/
