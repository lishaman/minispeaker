    ...
    if ((argc > 3) && strcmp(argv[3], "on") == 0) {
        if (argc == 4) {
            ...
            if (atoi(argv[4]) < 0 || atoi(argv[4]) > 7) {
                fprintf(stderr, "ERROR: Invalid User Priority!\n");
                return -EINVAL;
            }
        ...
        for (up_idx = up_idx_start; up_idx <= up_idx_stop; up_idx++) {
            ...
            if (ioctl(sockfd, ioctl_val, &iwr) < 0) {
                ...
                policedTime[up_idx] = queue_stats_cmd.policedTime;
            }
        }
...
process_tdls_discovery(int argc, char *argv[])
{
    ...
    if (argc != 4) {
        printf("ERR:Incorrect number of arguments.\n");
        printf
            ("Syntax: ./mlanconfig mlanX tdls_discovery <config/tdls.conf>\n");
        exit(1);
    }
...
process_tdls_powermode(int argc, char *argv[])
{
    ...
    if (argc != 4) {
        printf("ERR:Incorrect number of arguments.\n");
        printf
            ("Syntax: ./mlanconfig mlanX tdls_powermode <config/tdls.conf>\n");
        exit(1);
    }
...
process_tdls_channel_switch(int argc, char *argv[])
{
    ...
    if (argc != 4) {
        printf("ERR:Incorrect number of arguments.\n");
        printf
            ("Syntax: ./mlanconfig mlanX tdls_channel_switch <config/tdls.conf>\n");
        exit(1);
    }
    ...
    while (config_get_line(line, MAX_CONFIG_LINE, config_file, &li, &pos)) {
        ...
        if (strcmp(args[0], "PeerMAC") == 0) {
            ...
            if (param_buf->band != BAND_BG && param_buf->band != BAND_A) {
...
process_tdls_stop_channel_switch(int argc, char *argv[])
{
    ...
    if (argc != 4) {
        printf("ERR:Incorrect number of arguments.\n");
        printf
            ("Syntax: ./mlanconfig mlanX tdls_stop_channel_switch <config/tdls.conf>\n");
        exit(1);
    }
...
process_tdls_cs_params(int argc, char *argv[])
{
    ...
    if (argc != 4) {
        printf("ERR:Incorrect number of arguments.\n");
        printf
            ("Syntax: ./mlanconfig mlanX tdls_cs_params <config/tdls.conf>\n");
        exit(1);
    }
...
process_tdls_debug(int argc, char *argv[])
{
    ...
    /* same link */
        ...
        if (argc < 5) {
            printf("ERR:Incorrect number of arguments.\n");
            printf
                ("Syntax: ./mlanconfig mlanX tdls_debug setup_existing_link <0/1>\n");
            exit(1);
        }
        value = (t_u16) A2HEXDECIMAL(argv[4]);
    }
    /* fail_setup_confirm */
        ...
        if (argc < 5) {
            printf("ERR:Incorrect number of arguments.\n");
            printf
                ("Syntax: ./mlanconfig mlanX tdls_debug fail_setup_confirm <0/1>\n");
            exit(1);
        }
        value = (t_u16) A2HEXDECIMAL(argv[4]);
    }
    /* setup prohibited */
        ...
        if (argc < 5) {
            printf("ERR:Incorrect number of arguments.\n");
            printf
                ("Syntax: ./mlanconfig mlanX tdls_debug setup_with_prohibited <0/1>\n");
            exit(1);
        }
        value = (t_u16) A2HEXDECIMAL(argv[4]);
    }
    /* setup higher/lower mac */
        ...
        if (argc < 5) {
            printf("ERR:Incorrect number of arguments.\n");
            printf
                ("Syntax: ./mlanconfig mlanX tdls_debug higher_lower_mac <0/1>\n");
            exit(1);
        }
        value = (t_u16) A2HEXDECIMAL(argv[4]);
    }
    /* ignore key lifetime expiry */
        ...
        if (argc < 5) {
            printf("ERR:Incorrect number of arguments.\n");
            printf
                ("Syntax: ./mlanconfig mlanX tdls_debug ignore_key_expiry <0/1>\n");
            exit(1);
        }
        value = (t_u16) A2HEXDECIMAL(argv[4]);
    }
    /* allow weak security */
        ...
        if (argc < 5) {
            printf("ERR:Incorrect number of arguments.\n");
            printf
                ("Syntax: ./mlanconfig mlanX tdls_debug allow_weak_security <0/1>\n");
            exit(1);
        }
        value = (t_u16) A2HEXDECIMAL(argv[4]);
    }
    ...
    /* Immediate return */
        ...
        if (argc < 5) {
            printf("ERR:Incorrect number of arguments.\n");
            printf
                ("Syntax: ./mlanconfig mlanX tdls_debug cs_im_return <0/1>\n");
            exit(1);
        }
        value = (t_u16) A2HEXDECIMAL(argv[4]);
    } else {
