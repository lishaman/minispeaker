...
process_getscantable(int argc, char *argv[])
{
    ...
    struct wlan_ioctl_get_scan_list *curr = NULL, *prev = NULL, *next = NULL;
    ...
    do {
        ...
        for (idx = 0; (unsigned int) idx < prsp_info->scan_number; idx++) {
            ...
            /* Create a sorted list of BSS using Insertion Sort. Sort as per
               Signal Strength (descending order) */
            ...
            if (scan_list_head == NULL) {
                ...
                curr_ss = 255 - scan_list_head->fixed_buf.fixed_fields.rssi;
                ...
                if (new_ss > curr_ss) {
                    ...
                    for (curr = scan_list_head; curr != NULL; curr = curr->next) {
