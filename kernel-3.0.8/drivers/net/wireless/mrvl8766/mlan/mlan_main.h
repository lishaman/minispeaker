...
#define IS_CARD_RX_RCVD(adapter) (adapter->cmd_resp_received || \
                                  adapter->event_received || \
				  				  util_peek_list(adapter->pmoal_handle, \
                                    &adapter->rx_data_queue, \
...
/** Handles host to device heart beat */
t_void wlan_host_heart_beat(void *function_context);
/** Handles device to host heart beat */
t_void wlan_device_heart_beat(void *function_context);
...
mlan_status wlan_usb_host_to_card_aggr(IN pmlan_adapter pmadapter,
                                       ...
                                       IN usb_tx_aggr_params * aggr_params);
...
mlan_status wlan_misc_ioctl_usb_aggr_ctrl(IN pmlan_adapter pmadapter,
                                          IN pmlan_ioctl_req pioctl_req);
