...
enum _mlan_ioctl_req_id
{
    ...
    MLAN_OID_MISC_HEART_BEAT = 0x00200004,
...
typedef struct _mlan_debug_info
{
    ...
    /** Number of card to host failures */
    t_u32 num_card_to_host_failure;
...
/** Heart Beat Configuration: Disable */
#define HB_CFG_DISABLE          0x0000
/** Heart Beat Configuration: No change */
#define HB_CFG_NO_CHANGE        0xFFFF

/** Type definition of mlan_ds_misc_hb for MLAN_OID_MISC_HEART_BEAT */
typedef struct _mlan_ds_misc_heart_beat
{
    /** HeartBeat timer for the host in unit of 100 ms */
    t_u16 h2d_timer;
    /** Debug mode for host */
    t_u16 debug_for_host;
    /** HeartBeat timer for the device in unit of 100 ms */
    t_u16 d2h_timer;
    /** Delay time for reconnect in milliseconds */
    t_u16 reconnect_delay;
    /** Debug mode for device */
    t_u16 debug_for_device;
} mlan_ds_misc_heart_beat;
...
typedef struct _mlan_ds_misc_cfg
{
    ...
    union
    {
        ...
        t_u32 region_code;
        /** HeartBeat for MLAN_OID_MISC_HEART_BEAT */
        mlan_ds_misc_heart_beat heart_beat;
