...
typedef MLAN_PACK_START struct _HostCmd_DS_HEART_BEAT
{
    /** Action */
    t_u16 action;
    /** Timer for the host */
...
} MLAN_PACK_END HostCmd_DS_HEART_BEAT;
...
typedef MLAN_PACK_START struct _HostCmd_DS_FW_AUTO_RECONNECT
{
    ...
    /** flags:
      * [Bit 0]: Set to 1: Firmware should report link-loss to host if AP rejects
...
typedef MLAN_PACK_START struct _HostCmd_DS_PACKET_AGGR_OVER_HOST_INTERFACE
{
    ...
    t_u16 action;
    /**
     *  Host interface aggregation control TLV(s) to be sent in the firmware command
     *
