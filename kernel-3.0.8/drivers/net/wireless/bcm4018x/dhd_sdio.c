...
const static char *bcm4330b2_fw_name[] = {
        ...
        "fw_bcmdhd_apsta.bin", // "fw_bcm4330b2_apsta.bin",
        "fw_bcmdhd_p2p.bin"    // "fw_bcm4330b2_p2p.bin"
};

const static char *bcm43362a0_fw_name[] = {
        "fw_bcmdhd.bin",       //xzr "fw_bcm43362a0.bin",
        "fw_bcmdhd_apsta.bin", // "fw_bcm43362a0_apsta.bin",
        "fw_bcmdhd_p2p.bin"    // "fw_bcm43362a0_p2p.bin"
};
