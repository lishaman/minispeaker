...
static struct i2c_board_info grus_i2c2_devs[] __initdata = {
#ifdef CONFIG_SP0838
	{
...
static int __init grus_i2c_dev_init(void)
{
...
#if (defined(CONFIG_I2C0_JZ4780) || defined(CONFIG_I2C_GPIO))
	i2c_register_board_info(0, grus_i2c0_devs, ARRAY_SIZE(grus_i2c0_devs));
#endif

#if (defined(CONFIG_I2C1_JZ4780) || defined(CONFIG_I2C_GPIO))
	i2c_register_board_info(1, grus_i2c1_devs, ARRAY_SIZE(grus_i2c1_devs));
#endif
...
arch_initcall(grus_i2c_dev_init);
