...
{
	static struct wake_lock	*wifi_wake_lock = &bcm_ap6181_data.wifi_wake_lock;
	int reset;
	...
	bcm_ap6181_data.wifi_reset = reset;
...
{
	static struct wake_lock	*wifi_wake_lock = &bcm_ap6181_data.wifi_wake_lock;
	int reset = bcm_ap6181_data.wifi_reset;
...
EXPORT_SYMBOL(bcm_ap6181_wlan_init);
EXPORT_SYMBOL(bcm_ap6181_manual_sysfs_init);
