/*
 * jz4780cpm.h
 * JZ4780 CPM register definition
 * Copyright (C) 2010 Ingenic Semiconductor Co., Ltd.
 *
 * Author: whxu@ingenic.cn
 */

#ifndef __JZ4780CPM_H__
#define __JZ4780CPM_H__
...
#define JZ_EXTAL                48000000  /* Main extal freq:   48 MHz */
...
#define CPM_I2S1CDR_OFFSET	(0xa0)  /* rw, 32, 0x00000000 */
#define CPM_USBCDR_OFFSET	(0x50)  /* rw, 32, 0x00000000 */
#define CPM_LPCDR0_OFFSET	(0x54)  /* rw, 32, 0x00000000 */
#define CPM_LPCDR1_OFFSET	(0x64)  /* rw, 32, 0x00000000 */
...
#define CPM_GPUCDR_OFFSET	(0x88)  /* rw, 32, 0x40000000 */
#define CPM_HDMICDR_OFFSET	(0x8c)  /* rw, 32, 0x00000000 */
...
#define CPM_CPPCR_OFFSET	(0x0c)  /* rw, 32, 0x80000020 */
#define CPM_CPAPCR_OFFSET	(0x10)  /* rw, 32, 0x00000000 */
#define CPM_CPMPCR_OFFSET	(0x14)  /* rw, 32, 0x00000000 */
#define CPM_CPEPCR_OFFSET	(0x18)  /* rw, 32, 0x00000000 */
#define CPM_CPVPCR_OFFSET	(0x1c)  /* rw, 32, 0x00000000 */
...
#define CPM_CLKGR1_OFFSET	(0x28)  /* rw, 32, 0xffffffff */
...
#define CPM_I2S1CDR	(CPM_BASE + CPM_I2S1CDR_OFFSET)
#define CPM_USBCDR	(CPM_BASE + CPM_USBCDR_OFFSET)
#define CPM_LPCDR0	(CPM_BASE + CPM_LPCDR0_OFFSET)
#define CPM_LPCDR1	(CPM_BASE + CPM_LPCDR1_OFFSET)
...
#define CPM_HDMICDR	(CPM_BASE + CPM_HDMICDR_OFFSET)
...
#define CPM_CPPCR	(CPM_BASE + CPM_CPPCR_OFFSET)
#define CPM_CPAPCR	(CPM_BASE + CPM_CPAPCR_OFFSET)
#define CPM_CPMPCR	(CPM_BASE + CPM_CPMPCR_OFFSET)
#define CPM_CPEPCR	(CPM_BASE + CPM_CPEPCR_OFFSET)
#define CPM_CPVPCR	(CPM_BASE + CPM_CPVPCR_OFFSET)
...
/* xPLL control register (CPXPCR) */
#define CPXPCR_LOCK             BIT6   /* LOCK bit */
#define CPXPCR_XPLL_ON		BIT4
#define CPXPCR_XF_MODE		BIT3
#define CPXPCR_XPLLBP		BIT1
#define CPXPCR_XPLLEN		BIT0

#define CPXPCR_XPLLM_LSB         19
#define CPXPCR_XPLLM_MASK        BITS_H2L(31, CPXPCR_XPLLM_LSB)

#define CPXPCR_XPLLN_LSB         13
#define CPXPCR_XPLLN_MASK        BITS_H2L(18, CPXPCR_XPLLN_LSB)

#define CPXPCR_XPLLOD_LSB        9
#define CPXPCR_XPLLOD_MASK       BITS_H2L(12, CPXPCR_XPLLOD_LSB)
...
#define CLKGR0_LCD1             BIT28
#define CLKGR0_LCD0             BIT27
...
#define CLKGR1_P1               BIT15
#define CLKGR1_X2D              BIT14
#define CLKGR1_DES              BIT13
#define CLKGR1_I2C4		BIT12
#define CLKGR1_AHB_MON          BIT11
#define CLKGR1_UART4            BIT10
#define CLKGR1_HDMI             BIT9
#define CLKGR1_OTG1             BIT8
#define CLKGR1_GPVLC            BIT7
#define CLKGR1_AIC1             BIT6
#define CLKGR1_COMPRESS         BIT5
#define CLKGR1_GPU              BIT4
#define CLKGR1_PCM              BIT3
#define CLKGR1_VPU              BIT2
#define CLKGR1_TSSI1            BIT1
...
#define PCMCDR_PCMPCS_LSB	29       
#define PCMCDR_PCMPCS_MASK      BITS_H2L(30, PCMCDR_PCMPCS_LSB)
#define PCMCDR_PCMPCS_APLL	(0 << PCMCDR_PCMPCS_LSB)
#define PCMCDR_PCMPCS_MPLL	(1 << PCMCDR_PCMPCS_LSB)
#define PCMCDR_PCMPCS_EPLL	(2 << PCMCDR_PCMPCS_LSB)
#define PCMCDR_PCMPCS_VPLL	(3 << PCMCDR_PCMPCS_LSB)
...
#define GPUCDR_GPCS_LSB         30 
#define GPUCDR_GPCS_MASK        BITS_H2L(31, GPUCDR_GPCS_LSB)
#define GPUCDR_GPCS_STOP	(0 << GPUCDR_GPCS_LSB)
#define GPUCDR_GPCS_APLL	(1 << GPUCDR_GPCS_LSB)
#define GPUCDR_GPCS_MPLL	(2 << GPUCDR_GPCS_LSB)
#define GPUCDR_GPCS_EPLL	(3 << GPUCDR_GPCS_LSB)

#define GPUCDR_GPU_STOP		BIT26
#define GPUCDR_GPUDIV_LSB       0       /* GPUCDR bit */
#define GPUCDR_GPUDIV_MASK      BITS_H2L(3, GPUCDR_GPUDIV_LSB)

/* HDMI clock divider register */
#define HDMICDR_HPCS_LSB        30
#define HDMICDR_HPCS_MASK       BITS_H2L(31, HDMICDR_HPCS_LSB)
#define HDMICDR_HPCS_APLL	(0 << HDMICDR_HPCS_LSB)
#define HDMICDR_HPCS_MPLL	(1 << HDMICDR_HPCS_LSB)
#define HDMICDR_HPCS_VPLL	(2 << HDMICDR_HPCS_LSB)
#define HDMICDR_HPCS_CE         BIT29
#define HDMICDR_HPCS_BUSY       BIT28
#define HDMICDR_HDMI_STOP	BIT26
#define HDMICDR_HDMIDIV_LSB	 0
#define HDMICDR_HDMIDIV_MASK BITS_H2L(3, HDMICDR_HDMIDIV_LSB)
...
#define __cpm_start_hdmi()	(REG_CPM_CLKGR1 &= ~CLKGR1_HDMI)
#define __cpm_stop_hdmi()	(REG_CPM_CLKGR1 |= CLKGR1_HDMI)

#define cpm_get_pllout()	cpm_get_xpllout(SCLK_APLL)
#define cpm_get_pllout1()	cpm_get_xpllout(SCLK_MPLL)

#define __cpm_get_pixdiv() \
		((REG_CPM_LPCDR1 & LPCDR_PIXDIV_MASK) >> LPCDR_PIXDIV_LSB)
...
#define __cpm_suspend_uhc_phy()		(REG_CPM_OPCR &= ~OPCR_OTGPHY1_ENABLE)
#define __cpm_enable_uhc_phy()		(REG_CPM_OPCR |=  OPCR_OTGPHY1_ENABLE)
