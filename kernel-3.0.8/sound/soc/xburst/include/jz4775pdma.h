/*
 * linux/include/asm-mips/mach-jz4775/jz4775pdmac.h
 *
 * JZ4775 DMAC register definition.
 *
 * Copyright (C) 2010 Ingenic Semiconductor Co., Ltd.
 */

#ifndef __JZ4775PDMAC_H__
#define __JZ4775PDMAC_H__
...
#define REG_DMAC_DSIRQM		REG32(DMAC_DSIRQM)
...
#define __dmac_channel_stop_sync(n)	while ( !(REG_DMAC_DCCSR & (DMAC_DCCSR_HLT | DMAC_DCCSR_TT)) )
