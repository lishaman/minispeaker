...
/* Step Voltage */
#define D2041_BUCK_VOLT_STEP            25
#define D2041_LDO_VOLT_STEP             50

/* Buck Config Validation Macros */
#define D2041_BUCK12_VOLT_UPPER         2075
#define D2041_BUCK12_VOLT_LOWER         500
#define D2041_BUCK3_VOLT_UPPER          2500
#define D2041_BUCK3_VOLT_LOWER          925
#define D2041_BUCK4_VOLT_UPPER          3300
#define D2041_BUCK4_VOLT_LOWER          1200

/* Same for all LDO's */
#define D2041_LDO_VOLT_UPPER            3300
#define D2041_LDO_VOLT_LOWER            1200
...
struct d2041_pmic {
    ...
    /* regulator devices */
    struct platform_device *pdev[D2041_NUMBER_OF_REGULATORS];
};



int             d2041_platform_regulator_init(struct d2041 *d2041);

/*
* Additional support via regulator API
*/
//int             d2041_regulator_set_voltage(struct regulator_dev *rdev, int min_uV, int max_uV);
//int             d2041_regulator_get_voltage(struct regulator_dev *rdev);
//int             d2041_regulator_enable(struct regulator_dev *rdev);
//int             d2041_regulator_disable(struct regulator_dev *rdev);
//unsigned int    d2041_regulator_get_mode(struct regulator_dev *rdev);
//TODO unsigned int     d2041_regulator_set_mode(struct regulator_dev *rdev, unsigned int mode);
//int             d2041_regulator_is_enabled(struct regulator_dev *rdev);
