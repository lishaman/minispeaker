...
/* AV features masks */
#define BSA_AVK_FEAT_RCTG      BTA_AVK_FEAT_RCTG         /* remote control target */
#define BSA_AVK_FEAT_RCCT      BTA_AVK_FEAT_RCCT         /* remote control controller */
#define BSA_AVK_FEAT_PROTECT   BTA_AVK_FEAT_PROTECT      /* streaming media contect protection */
#define BSA_AVK_FEAT_VENDOR    BTA_AVK_FEAT_VENDOR       /* remote control vendor dependent commands */
#define BSA_AVK_FEAT_METADATA  BTA_AVK_FEAT_METADATA     /* AVRC Metadata transfer supported */
#define BSA_AVK_FEAT_BROWSE    BTA_AVK_FEAT_BROWSE       /* browsing channel support */
...
#define BSA_AVK_CMD_CTRL          BTA_AVK_CMD_CTRL
#define BSA_AVK_CMD_STATUS        BTA_AVK_CMD_STATUS
#define BSA_AVK_CMD_SPEC_INQ      BTA_AVK_CMD_SPEC_INQ
#define BSA_AVK_CMD_NOTIF         BTA_AVK_CMD_NOTIF
#define BSA_AVK_CMD_GEN_INQ       BTA_AVK_CMD_GEN_INQ

typedef UINT8 tBSA_AVK_CMD;

/* response codes for BSA_AvkVendorRsp */
#define BSA_AVK_RSP_NOT_IMPL      BTA_AVK_RSP_NOT_IMPL
#define BSA_AVK_RSP_ACCEPT        BTA_AVK_RSP_ACCEPT
#define BSA_AVK_RSP_REJ           BTA_AVK_RSP_REJ
#define BSA_AVK_RSP_IN_TRANS      BTA_AVK_RSP_IN_TRANS
#define BSA_AVK_RSP_IMPL_STBL     BTA_AVK_RSP_IMPL_STBL
#define BSA_AVK_RSP_CHANGED       BTA_AVK_RSP_CHANGED
#define BSA_AVK_RSP_INTERIM       BTA_AVK_RSP_INTERIM
...
/* data associated with BSA_AVK_REMOTE_CMD_MSG */
typedef struct
{
    UINT8 rc_handle;
    tBSA_AVK_RC rc_id;
    tBSA_AVK_STATE key_state;
} tBSA_AVK_REMOTE_CMD_MSG;
...
typedef tAVRC_REG_NOTIF_RSP         tBSA_AVK_REG_NOTIF_MSG;
typedef tAVRC_LIST_APP_ATTR_RSP     tBSA_AVK_LIST_APP_ATTR_MSG;
typedef tAVRC_LIST_APP_VALUES_RSP   tBSA_AVK_LIST_APP_VALUES_MSG;
typedef tAVRC_RSP                   tBSA_AVK_SET_PLAYER_APP_VALUE_MSG;
typedef tAVRC_GET_PLAY_STATUS_RSP   tBSA_AVK_GET_PLAY_STATUS_MSG;
typedef tAVRC_RSP                   tBSA_AVK_SET_ADDRESSED_PLAYER_MSG;
typedef tAVRC_CHG_PATH_RSP          tBSA_AVK_CHG_PATH_MSG;
typedef tBSA_AVK_GET_ELEMENT_ATTR_MSG tBSA_AVK_GET_ITEM_ATTR_MSG;
typedef tAVRC_RSP                   tBSA_AVK_PLAY_ITEM_MSG;
typedef tAVRC_RSP                   tBSA_AVK_NOW_PLAYING_MSG;
...
typedef union
{
    ...
    tBSA_AVK_REMOTE_CMD_MSG remote_cmd;
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkEnableInit(tBSA_AVK_ENABLE *pEnable);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkDisableInit(tBSA_AVK_DISABLE *p_disable);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkRegisterInit(tBSA_AVK_REGISTER *p_register);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkRegister(tBSA_AVK_REGISTER *pRegister);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkDeregisterInit(tBSA_AVK_DEREGISTER *p_deregister);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkDeregister(tBSA_AVK_DEREGISTER *pRegister);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkOpenInit(tBSA_AVK_OPEN * p_open);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkOpen(tBSA_AVK_OPEN *p_open);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkCloseInit(tBSA_AVK_CLOSE *p_close);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkClose(tBSA_AVK_CLOSE *pClose);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkStartInit(tBSA_AVK_START * p_start);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkStart(tBSA_AVK_START *pStart);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkStopInit(tBSA_AVK_STOP *p_stop);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkStop(tBSA_AVK_STOP *pStop);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkRemoteCmdInit(tBSA_AVK_REM_CMD *pRemCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkRemoteCmd(tBSA_AVK_REM_CMD *pRemCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkVendorCmdInit(tBSA_AVK_VEN_CMD *pVenCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkVendorCmd(tBSA_AVK_VEN_CMD *pVenCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkCancelCmdInit(tBSA_AVK_CANCEL_CMD *pCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkCancelCmd(tBSA_AVK_CANCEL_CMD *pCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkListPlayerAttrCmdInit(tBSA_AVK_LIST_PLAYER_ATTR *pListPlayerAttrCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkListPlayerAttrCmd(tBSA_AVK_LIST_PLAYER_ATTR *pListPlayerAttrCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkListPlayerValuesCmdInit(tBSA_AVK_LIST_PLAYER_VALUES *pListPlayerValuesCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkListPlayerValuesCmd(tBSA_AVK_LIST_PLAYER_VALUES *pListPlayerValuesCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkGetPlayerValueCmdInit(tBSA_AVK_GET_PLAYER_VALUE *pGetPlayerValueCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkGetPlayerValueCmd(tBSA_AVK_GET_PLAYER_VALUE *pGetPlayerValueCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkSetPlayerValueCmdInit(tBSA_AVK_SET_PLAYER_VALUE *pSetPlayerValueCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkSetPlayerValueCmd(tBSA_AVK_SET_PLAYER_VALUE *pSetPlayerValueCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkGetPlayerAttrTextCmdInit(tBSA_AVK_GET_PLAYER_ATTR_TEXT *pGetPlayerAttrTextCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkGetPlayerAttrTextCmd(tBSA_AVK_GET_PLAYER_ATTR_TEXT *pGetPlayerAttrTextCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkGetPlayerValueTextCmdInit(tBSA_AVK_GET_PLAYER_VALUE_TEXT *pGetPlayerValueTextCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkGetPlayerValueTextCmd(tBSA_AVK_GET_PLAYER_VALUE_TEXT *pGetPlayerValueTextCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkGetElementAttrCmdInit(tBSA_AVK_GET_ELEMENT_ATTR *pGetElemAttrCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkGetElementAttrCmd(tBSA_AVK_GET_ELEMENT_ATTR *pGetElemAttrCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkGetPlayStatusCmdInit(tBSA_AVK_GET_PLAY_STATUS *pPlayStatusCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkGetPlayStatusCmd(tBSA_AVK_GET_PLAY_STATUS *pPlayStatusCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkSetAddressedPlayerCmdInit(tBSA_AVK_SET_ADDR_PLAYER *pAddrPlayerCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkSetAddressedPlayerCmd(tBSA_AVK_SET_ADDR_PLAYER *pAddrPlayerCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkSetBrowsedPlayerCmdInit(tBSA_AVK_SET_BROWSED_PLAYER *pBrowsedPlayerCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkSetBrowsedPlayerCmd(tBSA_AVK_SET_BROWSED_PLAYER *pBrowsedPlayerCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkChangePathCmdInit(tBSA_AVK_CHG_PATH *pChangePathCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkChangePathCmd(tBSA_AVK_CHG_PATH *pChangePathCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkGetFolderItemsCmdInit(tBSA_AVK_GET_FOLDER_ITEMS *pGetFolderItemsCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkGetFolderItemsCmd(tBSA_AVK_GET_FOLDER_ITEMS *pGetFolderItemsCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkGetItemsAttrCmd(tBSA_AVK_GET_ITEMS_ATTR *pGetItemsAttrCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkPlayItemCmdInit(tBSA_AVK_PLAY_ITEM *pPlayItemCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkPlayItemCmd(tBSA_AVK_PLAY_ITEM *pPlayItemCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkAddToPlayCmdInit(tBSA_AVK_ADD_TO_PLAY *pAddToPlayCmd);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkAddToPlayCmd(tBSA_AVK_ADD_TO_PLAY *pAddToPlayCmd);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkOpenRcInit(tBSA_AVK_OPEN * p_open);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkOpenRc(tBSA_AVK_OPEN * p_open);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkCloseRcInit(tBSA_AVK_CLOSE *p_close);
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_AvkCloseRc(tBSA_AVK_CLOSE *p_close);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkRelayAudioInit(tBSA_AVK_RELAY_AUDIO *pRelayAudio);
...
**
*******************************************************************************/
tBSA_STATUS BSA_AvkRelayAudio(tBSA_AVK_RELAY_AUDIO *pRelayAudio);
#endif /* BSA_AVK_AV_AUDIO_RELAY */
