...
/*******************************************************************************
 **
 ** Function         BSA_BleClCancelConnectInit
 **
 ** Description      Initialize structure containing API parameters with default values
 **
 ** Parameters       Pointer on structure containing API parameters
 ...
 **
 *******************************************************************************/
tBSA_STATUS BSA_BleClCancelConnectInit(tBSA_BLE_CL_CANCEL_OPEN *p_cancel_open);

/*******************************************************************************
 **
 ** Function         BSA_BleClCancelConnect
 **
 ** Description      This function is called to cancel opening an BLE connection.
 **
 ** Returns          tBSA_STATUS
 **
 *******************************************************************************/
tBSA_STATUS BSA_BleClCancelConnect(tBSA_BLE_CL_CANCEL_OPEN *p_cancel_open);
