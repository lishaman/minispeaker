...
#define BTA_HH_APP_ID_GPAD          5  
#define BTA_HH_APP_ID_LE            0xff

/* defined the minimum offset */
#if defined(HIDH_UCD_INCLUDED) && (HIDH_UCD_INCLUDED == TRUE)
#define BTA_HH_MIN_OFFSET       (L2CAP_MIN_OFFSET+L2CAP_UCD_OVERHEAD+HID_HDR_LEN)
#else
#define BTA_HH_MIN_OFFSET       (L2CAP_MIN_OFFSET+HID_HDR_LEN)
#endif
...
#define BTA_HH_STO_PARAM_INVALID 0
#define BTA_HH_STO_PARAM_DEFAULT 3200
...
typedef struct
{
    ...
    UINT16              sup_tout;       /* supervision timeout */
