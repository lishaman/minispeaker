...
typedef enum
{
    ...
    BSA_SEC_UNKNOWN_LINKKEY_EVT  /* unknown link key */
} tBSA_SEC_EVT;
...
#define BSA_BLE_SEC_AUTH_REQ_SETTING  BTM_AUTH_AP_YES
#endif
...
typedef struct
{
    ...
    UINT8           ble_addr_type;      /* BLE addr type */
#endif
} tBSA_SEC_LINK_UP;
...
/* RSSI/Quality measurement */
#define BSA_SEC_SIG_STRENGTH_RSSI           BTA_SIG_STRENGTH_RSSI_MASK
#define BSA_SEC_SIG_STRENGTH_LINK_QUALITY   BTA_SIG_STRENGTH_LINK_QUALITY_MASK
#define BSA_SEC_SIG_STRENGTH_RAW_RSSI       4
typedef INT8 tBSA_SIG_STRENGTH_MASK;

typedef INT8 tBSA_SEC_RSSI_VALUE;
typedef INT8 tBSA_SEC_LINK_QUALITY_VALUE;
typedef INT8 tBSA_SEC_RAW_RSSI_VALUE;
...
typedef struct
{
    ...
    tBSA_SEC_RSSI_VALUE  rssi_value;    /* 'Regular' RSSI value (BR/EDR:dB; BLE:dBm) */
    tBSA_SEC_RAW_RSSI_VALUE raw_rssi_value; /* Raw RSSI (always dBm) */
    tBSA_SEC_LINK_QUALITY_VALUE link_quality_value;
    tBSA_TRANSPORT link_type;
} tBSA_SEC_SIG_STRENGTH;

typedef struct
{
    BD_ADDR         bd_addr;            /* BD address peer device. */
} tBSA_SEC_LINK_KEY_UNKNOWN;
...
typedef union
{
    ...
    tBSA_SEC_LINK_KEY_UNKNOWN lost_link_key;	/* link key lost or unknown */
} tBSA_SEC_MSG;
