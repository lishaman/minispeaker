...
/* Callback function for notifying an application that a wifi channel is up or down.
** This asynchronous event is enabled/disabled by calling BTM_RegForWifiChanNotif().
*/

typedef void (tBTM_WIFI_EVT_CB) (UINT8 chnl, BOOLEAN is_up);
...
/*    BTM_EIR_UUID_SERVCLASS_PUBLIC_BROWSE_GROUP,       */
    ...
    BTM_EIR_UUID_SERVCLASS_BAV_SOURCE, /* BSA_SPECIFIC */
...
#if (defined BTM_TBFC_INCLUDED && BTM_TBFC_INCLUDED == TRUE) /* BSA_SPECIFIC */
    ,BTM_BL_SUSPEND_EVT
    ,BTM_BL_RESUME_EVT
#endif
...
#if (defined BTM_TBFC_INCLUDED && BTM_TBFC_INCLUDED == TRUE) /* BSA_SPECIFIC */
    tBTM_BL_SUSPEND_DATA    suspend; /* The data associated with BTM_BL_SUSPEND_EVT */
    tBTM_BL_RESUME_DATA     resume;  /* The data associated with BTM_BL_RESUME_EVT */
#endif
...
** SCO Routing Path
********************/
#define BTM_SCO_ROUTE_PCM           0
#define BTM_SCO_ROUTE_HCI           1
...
enum
{
    ...
    ,BTM_SP_RMT_OOB_EXT_EVT /* received REMOTE_OOB_DATA_REQUEST event for connection that supports Secure Connections (SC) */
#endif
};
...
#if BTM_OOB_INCLUDED == TRUE
#define BTM_OOB_PRESENT_192 BTM_OOB_PRESENT
#endif
...
#if (BTM_BR_SC_INCLUDED == TRUE)
/* data type for BTM_SP_RMT_OOB_EXT_EVT */
#endif
typedef struct
{
    BD_ADDR         bd_addr;        /* peer address */
...
*/
typedef void (tBTM_SEC_CBACK) (BD_ADDR bd_addr, tBT_TRANSPORT transport, void *p_ref_data, tBTM_STATUS result);
...
/*******************************************************************************
**
** Function         BTM_SetLocalBleDeviceName
**
** Description      This function is called to set the local ble device name.
**
** Returns          BTM_CMD_STARTED if successful, otherwise an error
**
*******************************************************************************/
    BTM_API extern tBTM_STATUS BTM_SetLocalBleDeviceName (char *p_name);
...
/*******************************************************************************
**
** Function         BTM_ReadLocalBLEDeviceName
**
** Description      This function is called to read the local ble device name.
**
** Returns          status of the operation
**                  If success, BTM_SUCCESS is returned and p_name points stored
**                              local device name
...
**
*******************************************************************************/
    BTM_API extern tBTM_STATUS BTM_ReadLocalBLEDeviceName (char **p_name);
...
/*******************************************************************************
**
** Function         BTM_RegForWifiChanNotif
**
**
...
** Return           tBTM_STATUS
*******************************************************************************/
    BTM_API extern tBTM_STATUS  BTM_RegForWifiChanNotif (tBTM_WIFI_EVT_CB *p_cb, BOOLEAN is_register);
...
**
*******************************************************************************/
    BTM_API extern tBTM_STATUS BTM_ReadTxPower (BD_ADDR remote_bda, tBT_TRANSPORT transport, tBTM_CMPL_CB *p_cb);
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SetWBSCodec_Modified (tBTM_SCO_CODEC_TYPE codec_type,UINT16 handle);

/* BSA_SPECIFIC */
/*******************************************************************************
**
** Function         BTM_SetSCOTimeSlot
**
** Description      This function sends command to the controller to setup
**                  PCM time slot for the upcoming SCO connection.
**
** Returns          BTM_ILLEGAL_VALUE: illegal value for the time slot
**                  BTM_SUCCESS:       otherwise
**
*******************************************************************************/
    BTM_API extern tBTM_STATUS BTM_SetSCOTimeSlot (UINT16 slot);
...
**
*******************************************************************************/
    BTM_API extern tBTM_STATUS BTM_SecBondByTransport (BD_ADDR bd_addr, tBT_TRANSPORT transport,
                                            UINT8 pin_len, UINT8 *p_pin,
                                            UINT32 trusted_mask[]);
...
**
*******************************************************************************/
    BTM_API extern void BTM_RemoteOobExtDataReply(tBTM_STATUS res, BD_ADDR bd_addr, BT_OCTET16 c_192, BT_OCTET16 r_192,
...
**
*******************************************************************************/
    BTM_API extern UINT16 BTM_BuildOobExtData(UINT8 *p_data, UINT16 max_len, BT_OCTET16 c_192,
...
**
*******************************************************************************/
    BTM_API extern UINT16 BTM_GetHCIConnHandle (BD_ADDR remote_bda, tBT_TRANSPORT transpor);
...
**
*******************************************************************************/
    BTM_API extern tBTM_STATUS BTM_SetTriggeredClockCapture(UINT16 conn_handle, UINT8 enable,
...
/*******************************************************************************
**
** Function         BTM_SecAddAmpKey
**
** Description      Add AMP Link Key to an existing Device record.
**                  This function shall only be called AFTER BTM_SecAddDevice has been called.
**                  It is normally called during host startup to restore all required information
**                  stored in the NVRAM.
**
** Parameters:      bd_addr     - BD address of the peer
**                  amp_key     - AMP link key.
**                  key_type    - HCI_LKEY_TYPE_AMP_WIFI or HCI_LKEY_TYPE_AMP_UWB
**
** Returns          TRUE if added OK, else FALSE
**
*******************************************************************************/

    BTM_API extern BOOLEAN BTM_SecAddAmpKey (BD_ADDR bd_addr, AMP_LINK_KEY amp_key, UINT8 key_type);
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_MIP_SetMode (BD_ADDR rem_addr, UINT8 mip_role, UINT8 mip_mode);
